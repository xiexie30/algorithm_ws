...
if __name__ == '__main__':
    keypoint_classification = KeypointClassification(
        path_model='/home/admin508/llf/Graduation_Thesis/YoloV8-Pose-Keypoint-Classification-master/YoloV8-Pose-Keypoint-Classification-master/models/nei_pose_3_classification.pth'
    )
